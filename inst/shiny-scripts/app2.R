...
server <- function(input, output, session) {
  ...
  # Add demo data option on the left hand side
  # if user clicks demo button
  observeEvent(input$demo, {
    dataset(ARLDataDownload)   # toydata comes from your package
  })


  # Step I: If file upload, save Input csv As a Reactive
  csvInput <- reactive({
