...
`libraryStatistics` is a Shiny Dashboard that permit to visualize
library statistics from the annual survey of Association of Research
Libraries developed using R.
